...
/* This is the custom StimulusReflex controller for the Article Reflex.
...
export default class extends ApplicationController {
  ...
  */
   ...
   *
   * Important:
   * Make sure to add data-controller="article" to your markup alongside
   * data-reflex="Article#dance" for the lifecycle methods to fire properly.
   *
   * Example:
   *
   *   <a href="#" data-reflex="click->Article#dance" data-controller="article">Dance!</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "Article#dance"
   *
